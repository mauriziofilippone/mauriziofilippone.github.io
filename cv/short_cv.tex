...
\item Fall 2015 to Fall 2018 -- {\em Ma\^{i}tre de Conf\'{e}rences Classe 1} -- % \\
%  Department of Data Science,
  EURECOM, Biot, France % \\
  %% Keywords: Bayesian inference, Nonparametric modeling, Scalable inference
...
As of Dec 2025, I've received about 5500 citations and my $h$-index is 37 (source Google Scholar).

\subsection*{Selected Research Grants}
\begin{itemize}
  \item Co-PI: \emph{Assessing livestock grazing impacts and carrying capacity in Saudi Arabia's terrestrial ecosystems} (\$675K), 2025--2028, Competitive Research Grants call at KAUST
...
I'm currently co-supervising two {\bf post-docs} ({\bf Emmanuel Ambriz} and {\bf Mohamad Hittawe}).
%% \paragraph{Post-Doc Supervision:}
Before joining KAUST, I supervised two post-docs, {\bf Simone Rossi} and {\bf Dimitrios Milios}, who were partially funded by two grants on fundamentals of Bayesian Statistics.
I also co-supervised one post-doc {\bf Giulio Franzese} on representation learning and generative modeling.
...
I'm currently supervising three Ph.D. students ({\bf Mattia Rosso}, {\bf Madi Matymov}, and {\bf Simon Galeano-Mu\~oz}), and one Ms/Ph.D. student ({\bf Temirlan Sergazy}). 
Before joining KAUST, I completed the supervision of three {\bf Ph.D. students} at EURECOM, {\bf Bogdan Kozyrskiy} (ended in Spring 2023), and {\bf Ba-Hien Tran} (ended in Fall 2023) who were partially funded by two grants on fundamentals of Bayesian Statistics; the third Ph.D. student {\bf Davit Gogolashvili} was funded by European training network on Machine Learning for Wireless Communication Networks (EU grant WindMILL).
Between 2015 and 2020 I graduated five Ph.D. students under my supervision at EURECOM, {\bf Jonas Wacker}, {\bf Kurt Cutajar}, {\bf Gia-Lac Tran}, {\bf Simone Rossi}, and {\bf Remi Domingues}, the first four on fundamentals of Bayesian Statistics, and the last one on statistical methods for fraud detection in collaboration with the company Amadeus. % in Sophia Antipolis, France. 
%% \paragraph*{Ph.D. Co-Supervision:}
At the same time, I also co-supervised Ph.D. students funded by industry with Amadeus on time series ({\bf Rosa Candela}) and with SAP on interpretability ({\bf Graziano Mita}). % , and with Renault Software Labs on representation and reinforcement learning for vehicular technologies ({\bf Ugo Lecerf} and {\bf Matthieu Da Silva Filarder}).
...
After joining EURECOM, I gave lectures on Bayesian Statistics in a course named {\bf Advanced Statistical Inference}.
...
Here is a selection including the most prestigious ones:
  ...
  I'm acting as an {\bf Area Chair} for AISTATS since 2020 and as a {\bf Senior Area Chair} for AISTATS since 2023, as well as an {\bf Area Chair} for ICML since 2026.
  In 2025, I was {\bf Senior Program Committee} member for the AAAI conference, and I was {\bf Guest Editor} for the ECML/PKDD Machine Learning Journal track in 2020.
...
I constantly receive invitations to deliver {\bf keynote} presentations at international events.
In 2025, I was invited for a keynote at the Huawei Lavender Summit in Paris. 
...
Between 2016 and 2021, I was also named collaborator in two grants to develop the application of Bayesian Statistics to neuroscience and spatial statistics. 
...
\input{../_bibliography/publications_list.tex}
